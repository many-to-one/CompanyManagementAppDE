...
urlpatterns = [
    ...
    path('success_delete_list_user_work/', success_delete_list_user_work, name='success_delete_list_user_work'),
    ...
    path('success_delete_workobject/<work_object_name>/', success_delete_workobject, name='success_delete_workobject'),
